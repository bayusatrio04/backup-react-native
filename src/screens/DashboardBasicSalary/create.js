...
const DashboardBasicSalaryCreateScreen = ({ navigation }) => {
    ...
    const handleSubmit = async () => {
        ...
        try {
            const response = await axios.post(
                'https://basically-wanted-wombat.ngrok-free.app/rest-api-yii/frontend/web/index.php?r=position-employees-salaries/create',
                updatedFormData,
                {
                    headers: {
            ...
            if (response.status === 201) {
                SweetAlert.showAlertWithOptions({
                    title: 'Messages',
                    subTitle: 'Berhasil Menambah Data Basic Salary',
                    confirmButtonTitle: 'OK',
                    confirmButtonColor: '#c71515',
                    otherButtonTitle: 'Cancel',
                    otherButtonColor: '#dedede',
                ...
                console.log('Data Basic Salary berhasil ditambah ke database!');
                setFormData({
                    gaji_pokok: '',
                ...
                SweetAlert.showAlertWithOptions({
                    title: 'Messages',
                    subTitle: 'Gagal menyimpan data Gaji Pokok ke database.',
                    confirmButtonTitle: 'OK',
                    confirmButtonColor: '#c71515',
                    otherButtonTitle: 'Cancel',
                    otherButtonColor: '#dedede',
                ...
                console.error('Gagal menyimpan data Gaji Pokok ke database.');
            }
        } catch (error) {
    ...
    const goToPayrollManagement = () => {
        navigation.navigate('Payroll Management');
        console.log('Payroll Management Screen');
    };
        ...
        <ScrollView style={styles.container}>
            <View style={styles.dasarRed}>
                <View style={styles.headerContainer}>
                    ...
                    <Text style={styles.headerText}>Create New Basic Salary</Text>
                </View>
            </View>
            ...
            <View style={styles.contentWhite}>
                    ...
                    <View style={styles.inputContainer}>
                        <View style={styles.inputContainerStyle}>
                            <TextInput
                                ...
                                label="Masukkan Gaji (contoh:4500000)"
                                onChangeText={value => handleChange('gaji_pokok', value)}
                ...
                <TouchableOpacity style={[styles.button]} onPress={handleSubmit}>
                    <Text style={styles.buttonText}>Create New Basic Salary</Text>
                </TouchableOpacity>
            </View>
